                                ...
                                <ul id="nav" class="navbar-nav ml-auto">
                                    @auth
                                        @if(Auth::user()->role != 'admin')
                                            ...
                                            <li class="nav-item">
                                                <a @class(['active' => Request::is('aboutUs')]) href="/aboutUs">about
                                                    us</a>
                                            </li>
                                        @endif
                                    @elseguest
                                    ...
                                    @auth
                                        ...
                                        <li class="ml-4 d-flex align-items-center justify-content-end">
                                            <a class="p-0" href="/profilo">
                                                @if(Auth::user()->avatar !== '')
                                                    <img src="{{asset(Auth::user()->avatar)}}" alt="profile avatar"
                                                         class="profile">
                                                @endif
                                                @unless(Auth::user()->avatar !== '')
                                                    <img
                                                        src="https://avatars.dicebear.com/api/male/{{Auth::user()->firstname}}.svg"
                                                        alt="profile avatar" class="profile">
                                                @endunless
                                            </a>
                                        </li>
                                    @endauth
